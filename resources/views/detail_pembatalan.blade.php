                    ...
                    <div class="col-6">
                      ...
                      {{-- <div class="col mt-3">
                        ...
                        <a href="#" class="pop" style="position: relative;">
                          <img class="rounded" src="{{ asset('storage/ktp/' . $ktp) }}" style="width:180px; height:120px; z-index:1; position: relative;" alt="">
          ...
          @foreach ($detail as $detail)
            <div class="card" style="padding:16px;">
                ...
                <div class="row" style="margin-top: 16px">
                    <div class="col-6">
                        <h3 style="color: red">Alasan Pembatalan</h3>
                    </div>
                    <div class="col-6 text-right" style="padding-right:30px">
                        <h3 style="color: red"><b>{{ $detail->alasan }}</b></h3>
                    </div>
                </div>
                <hr>
                <div class="row">
