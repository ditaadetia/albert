    ...
    <div class="row">
      <div class="col-xl-12 col-md-12 ">
            ...
            <div class="card-header" style="background-color:#364a76">
                ...
                <div class="col-xl-10">
                    <h3 class="mb-0 text-white">Edit Alat </h3>
                </div>
                <div class="col-md-2">
                ...
                <form action="{{ route('equipments.update', ['equipment' => $equipment->id]) }}" method="POST" class="well" id="block-validate" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="keterangan" name="keterangan" class="form-control" placeholder="Spesifikasi" value="{{ old('keterangan', $equipment->keterangan) }}" required>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
