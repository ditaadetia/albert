    ...
    <div class="col">
      <div class="card bg-default shadow" style="border-radius:50px !important;">
        <div class="card-header bg-default">
          <div class="row">
            <div class="col-9">
              <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main" action="/cari-pembatalan" method="get">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form action="{{ route('cancelExcel') }}" method="POST" class="well" id="block-validate">
                      @csrf
                      @method('PUT')
                  ...
                  <tr style="text-align:center !important;">
                    ...
                    <td>
                      @if($order->category_order_id === 1)
                        Umum
                      @elseif($order->ket_verif_admin === 2)
                        Kegiatan Rutin
                      @elseif($order->ket_verif_admin === 3)
                        Dinas Lain
                      @elseif($order->ket_verif_admin === 4)
                        Sosial Masyarakat
                      @endif
                    </td>
                    {{-- <td>
                    ...
                    <td>
                      <a href="{{ route('detailPembatalan', ['id' => $order->id]) }}">
